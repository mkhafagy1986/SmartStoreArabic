	...
	SmartGallery.prototype = {
		...
		initGallery: function () {
			...
			var options = {
				...
				dots: true,
				arrows: false,
				//prevArrow: '<button type="button" class="btn btn-secondary btn-flat btn-circle slick-prev"><i class="fa fa-angle-right"></i></button>',
				//nextArrow: '<button type="button" class="btn btn-secondary btn-flat btn-circle slick-next"><i class="fa fa-angle-left"></i></button>',
				cssEase: 'ease-in-out',
				speed: isTouch ? 250 : 0,
				useCSS: true,
				useTransform: true,
